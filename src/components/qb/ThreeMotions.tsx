      ...
      <div className="flex items-end justify-between flex-wrap gap-6 mb-8">
        <div>
          <div className="font-mono-caps text-glow/80 mb-4 flex items-center gap-2 text-xs tracking-[0.2em]">
            ...
            How It Works · 3 Steps from Door to Counter
          </div>
          <h2 className="font-display text-4xl sm:text-6xl text-cream leading-[0.95] max-w-3xl">
            One simple flow.
            <br />
            <span className="text-glow italic font-normal">Zero waiting room crowd.</span>
          </h2>
        </div>
        <p className="text-cream/60 max-w-sm leading-relaxed text-sm sm:text-base">
          From the instant a customer scans your counter QR code to the moment their turn begins, every token updates in real time.
        </p>
      </div>
